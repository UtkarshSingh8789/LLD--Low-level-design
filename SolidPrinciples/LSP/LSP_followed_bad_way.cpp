...
public:
    ...
    void processTransactions() {
        for (Account* acc : accounts) {
            ...
            typeid(*acc);
            // Gets the runtime type information (RTTI) of the object pointed to by acc.
            // For example, if acc actually points to a FixedTermAccount object, it will get the type info of FixedTermAccount.
            // typeid(FixedTermAccount):
            // Gets the type info of the class FixedTermAccount.
